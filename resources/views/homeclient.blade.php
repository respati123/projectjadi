          ...
          <div class="row">
            <div class="col-md-12 wow fadeIn delay-05s">
              <div class="banner-text">
                <h2>Gis Palembang</h2>
                <p>Jelajahi Tempat Bersejarah di Palembang</p>
              </div>
              <div class="overlay-detail text-center">
                <a href="{{ route('login')}}"><i class="fa fa-angle-down"></i></a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 text-right">
          <h2 class="title-text">
            GIS<br><span class="deco">Palembang</span>
          </h2>
        </div>
        <div class="col-md-6 text-left">
          <div class="about-text">
            <p>Selamat datang di website sistem informasi geografis rumah sakit di kota palembang. anda dapat mencari informasi mengenai tempat sejarah.</p>
            <p>&nbsp;</p>
          </div>
        </div>
      </div>
